...
export async function generateJobKeywordProfile(
  ...
  const systemPrompt = [
    ...
    '- must_have_keywords: the strongest skills/domains a realistic match should usually show.',
    '- nice_to_have_keywords: useful supporting skills that improve rank but should not be mandatory.',
